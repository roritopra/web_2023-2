    ...
    <>
      <header className="py-6 bg-black px-10 flex items-center fixed top-0 w-full justify-between z-40 text-white">
        ...
        <nav className="hidden lg:block sm:hidden">
          <ul className="flex text-sm [&>li>a]:text-white [&>li>a]:transition-colors [&>li>a]:duration-500 [&>li>a]:text-current [&>li>a]:font-medium [&>li>a]:inline-block [&>li>a]:px-4 [&>li>a]:py-2">
            <li>
              <a href="/">Home</a>
            </li>
            <li>
        ...
        <nav className="flex flex-grow justify-end basis-0">
          <a
            href=""
            className="text-sm flex items-center gap-2 text-white py-1 px-3 bg-light-white rounded-lg"
          >
            3,2,1...
            <svg
